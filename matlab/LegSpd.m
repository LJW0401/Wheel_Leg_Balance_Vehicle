...
t106 = t88+t96;
t107 = t89+t97;
t79 = t74.*(1.9e+1./1.0e+2);
t80 = t75.*(1.9e+1./1.0e+2);
t81 = t72.*(1.9e+1./1.0e+2);
t82 = t73.*(1.9e+1./1.0e+2);
t84 = t12+t78;
...
t108 = t99+t102;
t109 = 1.0./t108;
spd = [(dphi4.*t105.*(t84.*t111.*(1.9e+1./2.5e+1)-t86.*t113.*(1.9e+1./2.5e+1)))./2.0+(dphi1.*t105.*(t84.*(t10-t110.*(1.9e+1./5.0e+1)).*2.0-t86.*(t12-t112.*(1.9e+1./5.0e+1)).*2.0))./2.0;dphi4.*t102.*t109.*(t103.*(imag(t113).*(1.9e+1./5.0e+1)-real(t111).*(1.9e+1./5.0e+1))+t98.*t104.*(imag(t111).*(1.9e+1./5.0e+1)+real(t113).*(1.9e+1./5.0e+1)))-dphi1.*t102.*t109.*(t103.*(t17-t18+imag(t112).*(1.9e+1./5.0e+1)-real(t110).*(1.9e+1./5.0e+1))-t98.*t104.*(t16+t19-imag(t110).*(1.9e+1./5.0e+1)-real(t112).*(1.9e+1./5.0e+1)))];
end
